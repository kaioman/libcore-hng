...
POOL_ID = "uw-prem-prod-pool"
PROVIDER_ID = "google-oidc-prod-provider"
SERVICE_ACCOUNT_EMAIL = "uw-secret-prod@gen-lang-client-0452718754.iam.gserviceaccount.com"
SECRET_ID = "DECRYPTION_KEY-prod"

# GCP側で設定した Issuer URL (1文字でも違うとNG)
ISSUER = "https://unchainworks.local" 
# 秘密鍵のパス
PRIVATE_KEY_PATH = os.path.expanduser("~/.ssh/uw_private_key_prod.pem")
# ---------------------------------------
